...
import {Image,ScrollView, SafeAreaView, StatusBar, Text, TouchableOpacity, View,StyleSheet} from "react-native";
        ...
        >
            ...
            <ScrollView>
                ...
                <View style={styles.header}>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('Region')} style={styles.btn}>
                        <Image style={{width:15,height:15,marginRight:5}} source={require('../../assets/loaction.png')}/>
                        <Text style={{color:"#8a8a8a",fontSize:13}}>Viloyat,tuman</Text>
                    </TouchableOpacity>
